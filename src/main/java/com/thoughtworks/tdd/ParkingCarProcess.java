...
public class ParkingCarProcess {
    ...
    public ParkingCarResult parkCar(Car car, List<ParkingLot> parkingLotList) throws CustomException {
    ...
    public ParkingCarResult parkCarBySmartParkingBoy(Car car, List<ParkingLot> parkingLotList) throws CustomException {
    ...
    public ParkingCarResult parkCarBySuperSmartParkingBoy(Car car, List<ParkingLot> parkingLotList) throws CustomException {
